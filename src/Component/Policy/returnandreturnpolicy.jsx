    ...
    <div>
      ...
      <Wrapper>
        ...
        <br/> 
          ...
          possible in this Return & Refund Policy, every time any of these terms
          are referenced, are strictly defined as: 
          <ul>
          <br/> 
          <li>
          Company: when this policy
          mentions “Company,” “we,” “us,” or “our,” it refers to streetswear,
          ...
          signs up to use the streetswear Innovations Private Limited Service to
          ...
          other device that can be used to visit streetswear and use the
          services. 
          </li>
          <br/> 
          <li>
          ...
          streetswear to use the Services. 
          </li>
          <br/>
      ...
      <TitleBold> Return & Refund Policy </TitleBold> 
          ...
          <br/> 
          Thanks for
          shopping at streetswear. We appreciate the fact that you like to buy
          ...
          conditions that apply to transactions at streetswear. We’ll be as
          brief as our attorneys will allow. The main thing to remember is that
          by placing an order or making a purchase at streetswear, you agree to
          the terms set forth below along with streetswear’s Privacy Policy.
          <br/> 
          <br/> 
          ...
          <TitleBold>Changes To Our Return & Refund Policy </TitleBold> 
           ...
           <br/> 
           Should we update,
          amend or make any changes to this document so that they accurately
          reflect our Service and policies. Unless otherwise required by law,
          those changes will be prominently posted here. Then, if you continue
          ...
          <TitleBold> Contact Us </TitleBold> 
           ...
           <br/> 
           If, for any
          reason, You are not completely satisfied with any good or service that
          we provide, do not hesitate to contact us and we will discuss any of
          ...
          <ul>
            <li>
            Via Email: support@streetswear.live
            </li>
            <br/>
            <li>
            Via this Link: https://www.streetswear.live</li>
          </ul>
          <br/>
            <br/>
